...
#check if the file has applications and grants - we are skipping designs
for file in pdf_files:
    journal = fitz.open('/Users/kratik/Documents/GitHub/indian-patent-dataset/pdf_download/' + file)
    for page in journal:
...
csv_file_path = os.path.join('/Users/kratik/Documents/GitHub/indian-patent-dataset/', 'applivations.csv') #create a application.csv
